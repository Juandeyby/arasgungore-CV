...
\section{Work Experience}
  ...
  \resumeSubHeadingListStart
    ...
    \resumeItemListStart
        \resumeItem{Developed a WebGL platform using JavaScript for file management, interconnected with Firebase Functions, Storage, and Authentication. The platform aimed to create VR environments with 360 photos. The interface was designed using Unity's Canvas, incorporating HTML elements. Supported multiple languages through Unity's Localization.}
        \resumeItem{Developed Android and iOS applications for the client, uploaded to the AppStore and PlayStore. Entire development managed through GitHub. Emphasis on graphical interface and functionalities.}
    \resumeItemListEnd
